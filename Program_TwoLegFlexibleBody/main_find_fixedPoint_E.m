...
%         fprintf('%1.4f',dtheta0)
        ...
        for i_gb = 1:length(gammaset)
            ...
            for i_gf = 1:length(gammaset)
                ...
                u_ini = [gb_ini gf_ini y0 phi0];
                [u_fix, logDat, exitflag] = func_find_fixedPoint_E(u_ini, E0, model, q_constants);
...
% 保存
filename = ['data/fixedPoints_for_E0=', num2str(E0), '_dx0=', num2str(dx0), '.mat'];

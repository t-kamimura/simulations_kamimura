...
for i = 1:length(fixedPoint)
    ...
    plot(rad2deg(fixedPoint(i).q_constants(3)), rad2deg(fixedPoint(i).u_fix(3)), 'marker',gaitMarker, 'markerfacecolor',markerColor, 'markeredgecolor', 'none','markersize',markerSize)
